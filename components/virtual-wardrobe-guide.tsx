  ...
  return (
    <article className="mx-auto mt-12 w-full max-w-4xl space-y-12 text-neutral-600 dark:text-neutral-300 [&_h2]:mb-5 [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:text-neutral-950 dark:[&_h2]:text-white [&_h3]:mb-3 [&_h3]:mt-6 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-neutral-950 dark:[&_h3]:text-white [&_p]:mt-4 [&_p]:leading-7 [&_a]:underline [&_a]:underline-offset-4">
      <section>
        ...
        <p>A virtual wardrobe is a collection of clothing images you can reuse, not a place where physical clothes are kept. Instead of re-uploading the same jacket every time you want to preview an outfit, you add it once, describe it briefly, and select it whenever you need it. VFitly stores each garment as an image plus a category, a color and optional tags, and keeps finished results in a separate folder so source garments and generated looks never get mixed up.</p>
      ...
      <section>
        ...
        <h3>Categories, colors and tags</h3>
        ...
        <p>Add the color you would genuinely use to describe the piece. &quot;Charcoal&quot; is more useful to future you than &quot;dark&quot;, and &quot;off-white&quot; is more useful than &quot;white&quot; when you are trying to match a specific outfit. If a garment has two dominant colors, record the second one as well.</p>
